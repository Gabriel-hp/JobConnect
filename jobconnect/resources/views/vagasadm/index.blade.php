        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm">
                            <a href="{{ route('vagasadm.edit', $vaga->id) }}" class="btn btn-primary btn-sm">Editar</a>
                        </div>

                    
                        <div class="col-sm">
                            <a href="{{ route('vagas.candidaturas', $vaga->id) }}" class="btn btn-primary btn-sm">Candidatos</a>
